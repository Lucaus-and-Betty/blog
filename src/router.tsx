...
import { Lucaus, Betty, Love, Web, Novel, Article, Error, Main, Diary, NovelChapter } from './routerLazyLoad.ts';
  ...
  createRoutesFromElements(
    <Route path="/" element={<App />} errorElement={<Error />}>
      <Route caseSensitive path="home" element={<Home />}>
        ...
        <Route caseSensitive path="novel/:author" element={<Novel />}></Route>
        <Route caseSensitive path="novel/chapter/:novelId" element={<NovelChapter />} />
